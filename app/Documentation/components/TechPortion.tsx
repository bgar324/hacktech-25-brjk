...
const TechPortion = () => {
  return (
    <>
      <div className="overflow-x-auto shadow-sm p-5 rounded-lg">
        <Table className="min-w-full relative">
          <TableHeader>
            <TableRow>
              <TableHead className="w-1/8 text-left">Layer</TableHead>
              <TableHead className="w-1/8 text-left">Technology</TableHead>
              <TableHead className="w-6/8 text-left">Purpose</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            <TableRow>
              ...
              <TableCell className="text-left break-words whitespace-normal">
                Captures high-fidelity 3D hand, wrist, and finger movement data
                at 120 frames per second using infrared imaging.
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="font-medium text-left">
            ...
            <TableRow>
              ...
              <TableCell className="text-left">
                Python + NumPy + WolframAlpha API
              </TableCell>
              <TableCell className="text-left break-words whitespace-normal">
                Extracts positional data, computes joint angles and ergonomic
                risk scores, and optionally solves complex ergonomic equations.
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="font-medium text-left">
            ...
            <TableRow>
              ...
              <TableCell className="text-left break-words whitespace-normal">
                Hosts the web application and ensures low-latency delivery of
                the dashboard to users globally.
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
