                ...
                <>
                      ...
                      <div className="mb-4">
                        ...
                        <ul className="list-none space-y-1 text-sm">
                          <li className={`flex items-center ${passwordChecks.length ? 'text-green-600' : 'text-red-600'}`}>
                            {passwordChecks.length ? '✓' : '×'} At least 8 characters long
                          </li>
                          <li className={`flex items-center ${passwordChecks.special ? 'text-green-600' : 'text-red-600'}`}>
                            {passwordChecks.special ? '✓' : '×'} Contains a special character
                          </li>
                          <li className={`flex items-center ${passwordChecks.capital ? 'text-green-600' : 'text-red-600'}`}>
                            {passwordChecks.capital ? '✓' : '×'} Contains a capital letter
                          </li>
                        </ul>
                      </div>
                    </>
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      disabled={isSignUp && !Object.values(passwordChecks).every(check => check)}
                      className={`w-full py-2 rounded-lg transition duration-200 cursor-pointer ${
                        isSignUp && !Object.values(passwordChecks).every(check => check)
