            ...
            <div className="flex flex-col gap-12 text-left">
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="text-gray-800">
                  ...
                  highest pressure is observed at 45° of wrist extension during
                  typing, while neutral (0°–15°) angles produce the lowest
                  pressure. Radial deviation (tilting the wrist toward the
                  thumb) at 15° also leads to elevated pressure compared to
                  neutral positioning.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="text-gray-800">
                  ...
                  average wrist extension was ~23.4° (left) and ~19.9° (right),
                  with an average ulnar deviation of ~14.7° (left) and ~18.6°
                  (right). Over 73% of participants typed with wrist extension
                  greater than 15°, exposing them to heightened risk of
                  ergonomic strain.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="text-gray-800">
                  ...
                  tunnel syndrome and repetitive strain injuries associated with
                  prolonged typing.
                </p>
              </div>
